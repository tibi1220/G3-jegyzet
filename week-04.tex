...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    node [left       , black] {$\rcurve{\gamma}_1$};
    ...
    node [below right, black] {$\rcurve{\rcurve{\gamma}}_2$};
...
\begin{equation*}
  \rcurve{\rcurve{\gamma}} = \rcurve{\gamma}_1 \cup \rcurve{\gamma}_2
\end{equation*}

\begin{equation*}
  \oint \limits_\rcurve{\gamma} \scalar{\rvec{w}}{\differential \rvec{r}}
  \; =
  \int \limits_{\rcurve{\gamma}_1} \scalar{\rvec{w}}{\differential \rvec{r}}
  + \int \limits_{-\rcurve{\gamma}_2} \scalar{\rvec{w}}{\differential \rvec{r}}
  \; =
  \int \limits_{\rcurve{\gamma}_1} \scalar{\rvec{w}}{\differential \rvec{r}}
  - \int \limits_{\rcurve{\gamma}_2} \scalar{\rvec{w}}{\differential \rvec{r}}
  \; =
...
\begin{minipage}[c]{\textwidth}
  ...
  \begin{minipage}[c]{.44\textwidth}
    \begin{figure}[H]
      \centering
      \begin{tikzpicture}
        \draw [ultra thick] (-0.5,-1) node [left] {$\rcurve{\gamma}$} .. controls (-0.5,-1) and (0.5,-0.5) .. (0,0);
...
és $\vsurf{\varphi}: U \subset \mathbb{R}^2 \rightarrow S \cap V$
